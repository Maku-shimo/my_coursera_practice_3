...
1. The implementation of the page should follow the mockup illustrations shown below: desktop and tablet (same), mobile, and mobile with mobile menu dropdown shown. The implementation has to be JUST 1 page. In other words a single, responsive page.

2. The page must include a CSS file. No inline styles allowed. A CSS file should be placed into a `css` folder under the solution container folder, e.g., `module3-solution/css`.
...
<br><br>
(_Hint: See_ [_http://getbootstrap.com/components/#navbar_](http://getbootstrap.com/components/#navbar) _)
